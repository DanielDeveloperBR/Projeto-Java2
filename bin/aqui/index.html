      ...
      <nav class="navbar navbar-expand-lg navbar-light">
       ...
       <div class="collapse navbar-collapse" id="collapsibleNavbar" >
         <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
               <a class="nav-link cadastro"  href="cadastro.jsp">Cadastro</a>
             </li>
             <li class="nav-item">
 ...
 <section class="contact-section" id="contact">
    <div class="container">
        ...
        <!--form action="https://formsubmit.co/youremail@gmail.com"  onsubmit="Salvar()" method="POST"-->
         ...
         <input type="hidden" name="_next" value="http://127.0.0.1:5500/index.html" style="display: nome;">
         <!--não ir para outra pagina-->
         <!--Evitar spawm-->
        ...
        <div class="row">
            <div class="col-md-7">
                   ...
                   <div class="row">
                      <div class="col-md-12">
                          <button type="submit" id="botao" class="btn mybtn2">Enviar</button>
                      </div>
                   </div>
                </form>
            </div>
